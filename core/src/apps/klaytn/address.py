...
from apps.klaytn import networks


"""
We believe Klaytn should use 44'/8217'/a' for everything, because it is
account-based, rather than UTXO-based. Unfortunately, lot of Klaytn
...
the same scheme: 44'/8217'/0'/0/i and only the i is being iterated.
"""
...
def validate_full_path(path: list) -> bool:
    """
    Validates derivation path to equal 44'/8217'/0'/0/i,
...
def address_from_bytes(address_bytes: bytes, network=None) -> str:
    ...
    in https://github.com/klaytn/EIPs/blob/master/EIPS/eip-55.md
    """
